...
module "subnets" {
  source = "git@github.com:slovink/terraform-aws-subnet.git?ref=test"
  #  version             = "1.0.1"
...
module "ssh" {
  source = "git@github.com:slovink/terraform-aws-security-group.git?ref=1.0.0"
  #  version     = "1.0.1"
  name        = "${local.name}-ssh"
  environment = local.environment
  vpc_id      = module.vpc.id
...
module "kms" {
  source = "git@github.com:slovink/terraform-aws-kms.git?ref=vinod"
  #  version             = "1.0.1"
  name                = "${local.name}-kms"
  environment         = local.environment
  enabled             = true
